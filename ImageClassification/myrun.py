...
main(dataset=dataset,
    ...
    initial_alpha=initial_alpha, lr=learning_rate, batch_size=batch_size, target_epsilon = epsilon, 
    target_delta= delta, logdir=logdir, target_epoch=num_epoch, method = method )
