...
#--------------------------------------------------------------------
#--------------------------------------------------------------------
def AdaSig(model, optimizer, batch_size, learning_rate, summed_s_derivative, previous_summed_s_derivative,
  ...
  new_model = Update_model(model, noisy_summed_grads, optimizer, batch_size)
